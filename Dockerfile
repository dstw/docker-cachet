...
RUN mkdir -p /var/www/html && \
    ...
    touch /var/log/cachet.log && chown www-data:root /var/log/cachet.log
...
RUN wget https://github.com/CastawayLabs/cachet-monitor/releases/download/v3.0/cachet_monitor_linux_amd64 && \
    mv cachet_monitor_linux_amd64 /bin && \
    chmod +x /bin/cachet_monitor_linux_amd64
...
COPY conf/cachet_monitor.sh /bin/cachet_monitor.sh
COPY cachet_monitor.yml /var/www/html/cachet_monitor.yml
